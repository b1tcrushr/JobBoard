...
const { getAllJobs, getJobByEmployer, getJobById, createJob, updateJobById, closeJobById, reopenJobById, getJobStats, getAllJobsAdmin, deleteJobPermanently } = require("../controllers/jobsController");
